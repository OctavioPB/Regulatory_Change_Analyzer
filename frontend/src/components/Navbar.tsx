...
import { LayoutDashboard, Bell, ClipboardCheck, FileText, ShieldCheck, Play, TrendingUp, Flame, MessageSquare, FileSignature, Info } from "lucide-react";
